  ...
  return (
    <div className="mx-auto max-w-7xl space-y-7">
      <header>
        ...
        <h1 className="mt-2 text-3xl font-bold">Dashboard vận hành</h1>
        <p className="mt-2 text-sm text-neutral-600">
          Theo dõi funnel hồ sơ, SLA và các hàng đợi cần can thiệp.
        </p>
      </header>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <section className="rounded-2xl border border-neutral-200 bg-white p-5">
          <h2 className="font-bold">Funnel hồ sơ</h2>
        ...
        <section className="rounded-2xl border border-neutral-200 bg-white p-5">
          <h2 className="font-bold">Tải thẩm định</h2>
            ...
            {metrics.data.reviewerWorkload.length === 0 ? (
              ...
              metrics.data.reviewerWorkload.map((row) => (
                ...
                >
                  ...
                  <strong>{row.activeAssignments}</strong>
                </div>
              ))
            )}
          </div>
